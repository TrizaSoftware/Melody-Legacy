...
module.exports = class Command extends commandBase{
    ...
    async execute(type, message, args){
      ...
      cpu.usage().then(data => {
        let embed = new embedBase("Melody Information", undefined, [{name: "Contributors:", value: "<@669668229974720513>, <@288426084872224768>, <@833055170198896681>, <@250643356185657345>"},{name: "CPU Usage:", value: `${data}%`}, {name: "Version:", value: version}])
        if (type == "interaction"){
