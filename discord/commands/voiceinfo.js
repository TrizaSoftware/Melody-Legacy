...
module.exports = class Command extends commandBase{
    ...
    async execute(message, args){
      ...
      let data = getVCManager(message.guild.id)
       message.reply({embeds: [new embedBase("Voice Manager Info", "Current Voice Manager Information", [{name: "Current Channel:", value: `<#${data.currentChannelId}>`, inline: true},{name: "Looping:", value: data.loopType || "false", inline: true}])]})
      }
    }
}